...
public class TaskGradeController {
    ...
    public ResponseEntity<TaskGradeResponse> markStudent(@PathVariable("taskId") String taskId, @RequestBody @Valid TaskGradeRequest taskGradeRequest) {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<TaskGradeResponse> updateMarkedStudent(@PathVariable("markedStudentId") String markedStudentId, @RequestBody @Valid TaskGradeRequest taskGradeRequest) {
        return ResponseEntity.ok(taskGradeService.updateMarkedStudent(markedStudentId, taskGradeRequest));
    }

    @GetMapping("/all")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<List<TaskGradeResponse>> getAllMarkedStudents() {
        return ResponseEntity.ok(taskGradeService.getAllMarkedStudent());
    }

    @GetMapping("/byId/{markedStudentId}")
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    public ResponseEntity<TaskGradeResponse> getMarkedStudentById(@PathVariable("markedStudentId") String markedStudentId) {
